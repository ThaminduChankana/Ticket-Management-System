...
import org.concurrent.blockingqueue.client.Consumer;
import org.concurrent.blockingqueue.client.Producer;
import org.concurrent.blockingqueue.pool.TicketPool;
import org.concurrent.blockingqueue.pool.impl.BlockingQueueTicketPool;
import org.concurrent.blockingqueue.util.Reader;
import org.concurrent.blockingqueue.util.Writer;
...
public class BlockingQueueMain {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Using BlockingQueue TicketPool.");
        System.out.print("Enter pool capacity: ");
        int capacity = sc.nextInt();

        TicketPool pool = new BlockingQueueTicketPool(capacity);
